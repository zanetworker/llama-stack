...
def main():
    ...
    based on your specific use case and requirements. Choose between the form interface or 
    chat interface to get started.
    """)
    
    # Create tabs for different interfaces
    tab1, tab2 = st.tabs(["Form Interface", "Chat Interface"])
